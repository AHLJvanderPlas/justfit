export async function onRequestPost({ request, env }) {
  try {
    ...
    // Only save to DB if user exists
    if (user_id) {
      ...
      if (userExists) {
        ...
        await env.DB.prepare(`
          INSERT INTO day_plans 
            (id, user_id, date, plan_status, plan_json, generated_by, engine_version, created_at_ms, updated_at_ms)
    ...
    // Return plan without saving (guest/anonymous mode)
