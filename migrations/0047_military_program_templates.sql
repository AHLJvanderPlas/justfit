-- 0047: Military program templates and template items
--
-- Source: defensie-matrix-clean.json
-- 372 sessions → program_template rows (one per schema+cluster)
--              → program_template_items rows (one per exercise in session)
--
-- Deferred items (52 total, due to 4 unresolved exercises):
--   optillen-vanaf-de-grond               (34 occurrences across clusters)
--   til-draagtest-full-exercise           (6 occurrences)
--   til-draagtest-gewicht-plaatsen-naar-heupen (6 occurrences)
--   hardlopen-zone-3-5-minuten            (6 occurrences)
-- These items are OMITTED from program_template_items until the exercises are resolved.
--
