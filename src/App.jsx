...
// AwardsView and SettingsView are non-critical — lazy-loaded to reduce initial bundle.
...
// ─── ZWO EXPORT (Zwift) ───────────────────────────────────────────────────────
function generateZwoFile(sessionName, intervals, _ftpWatts) {
  const elements = [];
...
function generateErgFile(sessionName, intervals, ftpWatts) {
...
function generateRunningTcx(sessionName, steps, maxHr) {
